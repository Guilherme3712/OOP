...
public class Program {
        public static void main(String[] args) {
            ...
            Carro v2 = new Carro("Carro", "Lancer", "Mitsubishi", "Cinza", "Sedan", "Gasolina", 2018, 220);
            v2.desligar();
            v2.status();
            v2.tracao();
            v2.freio();
            ...
            Onibus v3 = new Onibus("Onibus", "Marcopolo Torino", "Mercedes", "Azul", "Serviço", "Gasolina", 2017, 120);
            v3.desligar();
            v3.status();
            v3.tracao();
            v3.freio();
